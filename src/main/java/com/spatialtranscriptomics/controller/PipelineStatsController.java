...
public class PipelineStatsController {
	...
	public @ResponseBody
	List<PipelineStats> list() {

		List<PipelineStats> pipelinestats = pipelinestatsService.list();
	...
	@RequestMapping(method = RequestMethod.GET)
	public @ResponseBody
	PipelineStats getForExperiment(@RequestParam(value = "experiment_id", required = true) String experimentId) {
		return pipelinestatsService.findByExperiment(experimentId);
	}
