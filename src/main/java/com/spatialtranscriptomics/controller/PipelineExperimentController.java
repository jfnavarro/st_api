...
public class PipelineExperimentController {
	...
	@RequestMapping(method = RequestMethod.GET)
	public @ResponseBody
	List<PipelineExperiment> listForAccount(@RequestParam(value = "account", required = true) String accountId) {
		return pipelineexperimentService.findByAccount(accountId);
	}
