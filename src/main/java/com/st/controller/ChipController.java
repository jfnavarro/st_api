...
public class ChipController {
    ...
    List<Chip> list() {
        ...
        if (chips == null) {
            ...
            throw new CustomNotFoundException("No chips found or you dont "
    ...
    public @ResponseBody
    HttpEntity<Chip> get(@PathVariable String id, 
        ...
        if (chip == null) {
            ...
            throw new CustomNotFoundException("A chip with this ID does not exist or "
                    + "you dont have permissions to access it.");
        }
        // Check if already newest.
        DateTime reqTime = DateOperations.parseHTTPDate(ifModifiedSince);
        if (reqTime != null) {
            DateTime resTime = chip.getLast_modified() == null 
        ...
        HttpEntity<Chip> entity = new HttpEntity<>(chip, headers);
    ...
    LastModifiedDate getLastModified(@PathVariable String id) {
        ...
        if (chip == null) {
            ...
            throw new CustomNotFoundException("A chip with this ID does "
                    + "not exist or you dont have permissions to access it.");
        }
    ...
    Chip add(@RequestBody @Valid Chip chip, BindingResult result) {
        ...
        if (chip.getId() != null) {
            ...
            throw new CustomBadRequestException("The chip you want "
                    + "to add must not have an ID. The ID will be autogenerated.");
        } else if (chipService.findByName(chip.getName()) != null) {
            logger.info("Failed to add chip. Duplicate name.");
            throw new CustomBadRequestException("A chip with this name "
                    + "exists already. Chip names are unique.");
        }
    ...
    void update(@PathVariable String id, @RequestBody @Valid Chip chip, BindingResult result) {
        ...
        if (!id.equals(chip.getId())) {
            ...
            throw new CustomBadRequestException("A chip with this ID does not "
