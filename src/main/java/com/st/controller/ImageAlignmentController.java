...
public class ImageAlignmentController {
    ...
    List<ImageAlignment> list(@RequestParam(value = "chip", required = false) String chipId) {
        ...
        if (imagealignments == null) {
            ...
            throw new CustomNotFoundException("No imagealignments found or you "
    ...
    public @ResponseBody
    HttpEntity<ImageAlignment> get(@PathVariable String id, 
        ...
        if (imagealignment == null) {
            ...
            throw new CustomNotFoundException("An imagealignment with this "
                    + "ID does not exist or you dont have permissions to access it.");
        }
        // Check if already newest.
        DateTime reqTime = DateOperations.parseHTTPDate(ifModifiedSince);
        if (reqTime != null) {
            DateTime resTime = imagealignment.getLast_modified() == null 
                    ? new DateTime(2012,1,1,0,0) : imagealignment.getLast_modified();
        ...
        HttpEntity<ImageAlignment> entity = new HttpEntity<>(imagealignment, headers);
    ...
    LastModifiedDate getLastModified(@PathVariable String id) {
        ...
        if (imagealignment == null) {
            ...
            throw new CustomNotFoundException("An image alignment with this "
                    + "ID does not exist or you dont have permissions to access it.");
        }
    ...
    ImageAlignment add(@RequestBody @Valid ImageAlignment imagealignment, BindingResult result) {
        ...
        if (imagealignment.getId() != null) {
            ...
            throw new CustomBadRequestException("The image alignment you want to "
                    + "add must not have an ID. The ID will be autogenerated.");
        }
    ...
    void update(@PathVariable String id, @RequestBody @Valid ImageAlignment imagealignment,
        ...
        if (!id.equals(imagealignment.getId())) {
            ...
            throw new CustomBadRequestException("An Image alignment with this ID "
